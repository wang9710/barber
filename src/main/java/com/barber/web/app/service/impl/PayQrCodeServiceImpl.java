...
import com.barber.web.utils.enums.OrderTypeEnum;
import com.barber.web.utils.enums.PayWayEnum;
...
import static com.barber.web.utils.enums.HttpCodeEnum.CODE_6000;
...
//    private PeOrdersDao peOrdersDao;
    ...
    public ApiResult pay(HttpServletRequest request, HttpServletResponse response, Integer id, String payWay) {
        if(id == null){
            return new ApiResult(CODE_6000.getCode(),CODE_6000.getMessage());
        }
        try {
