package com.barber.web.crm.service.impl;
...
import com.barber.web.app.vo.CrtPayVo;
import com.barber.web.crm.bo.OpenBo;
import com.barber.web.crm.service.OrderService;
import com.barber.web.entity.*;
import com.barber.web.utils.ApiResult;
import com.barber.web.utils.PayCommonUtil;
import com.barber.web.utils.enums.*;
...
import static com.barber.web.utils.enums.HttpCodeEnum.CODE_0000;
...
//            int updatepayinfos = payInfosDao.updateByOrderId(payInfos);
            ...
            if(map.get("resultCode").equals("SUCCESS")){
                ...
                ApiResult result = new ApiResult(CODE_0000.getCode(),CODE_0000.getMessage());
