...
public class SignUtil {
     ...
     * @return 要请求的签名参数数组
     */
    public static Map<String, String> signMap(Map<String, String[]> sParaTemp,String app_secret) {
        //请求参数Map转换验证Map，并生成要请求的签名参数数组
        return sign(toVerifyMap(sParaTemp, false),app_secret);
    }
     ...
     * @return 要请求的签名参数数组
     */
    public static Map<String, String> sign(Map<String, String> sParaTemp,String app_secret) {
        //时间戳加入签名参数组中
    ...
    public static String getSignStr(Map<String, String> sParaTemp,String app_secret) {
        return sign(sParaTemp,app_secret).get("signature");
    }
     ...
     * @return 请求的签名参数字符串
     */
    public static String signStringMap(Map<String, String[]> sParaTemp,String app_secret) {
        //生成要请求的签名参数数组
        Map<String, String> sign = signMap(sParaTemp,app_secret);
        //生成要请求的签名参数字符串“参数=参数值”&链接
     ...
     * @return
     */
    public static String signString(Map<String, String> sParaTemp,String app_secret) {
        //生成要请求的签名参数数组
        Map<String, String> sign = sign(sParaTemp,app_secret);
        //生成要请求的签名参数字符串“参数=参数值”&链接
        return createLinkString(sign, true);
    }
     ...
     * @return 验证结果
     */
    public static boolean verifyMap(Map<String, String[]> paramsMap,String app_secret) {
        //请求参数Map转换验证Map，并根据反馈回来的信息，生成签名结果
        return verify(toVerifyMap(paramsMap, false),app_secret);
    }
     ...
     * @return 验证结果
     */
    public static boolean verify(Map<String, String> params,String app_secret) {
        String sign = "";
        if (params.get("signature") != null) {
            sign = params.get("signature");
        }else {
            logger.info("signature is null");
            return false;
        }
        String timestamp = "";
